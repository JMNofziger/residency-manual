...
**Goal:** Static guided checklist: labor market test (HZZ) → stay-and-work permit (MUP), with nationality packs, cited facts, glossary, and offices address book. Real employer cases stay local (`cases/private/`).
...
| 6 | Remaining: steps 6–8 deepen | Next |
...
- Guided panels via [`js/guided-checks.js`](js/guided-checks.js) (Art. 99, occupation, employer package, LMT, worker docs)
