...
Priorities: canonical fact catalog, more nationality packs, anonymized export, EN/HR key parity in CI, hosting.
...
- CI: [`.github/workflows/lint-facts.yml`](.github/workflows/lint-facts.yml)
...
2. `npm run lint:facts` and `npm run test:gates` before push
